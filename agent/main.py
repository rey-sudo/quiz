...
def extraer_legal_financiero_estricto(ruta_pdf, pausa_debug=True):
    ...
    nombre_base = os.path.splitext(ruta_pdf)[0]
...
# Ejecución
extraer_legal_financiero_estricto("input/decreto_1165_2019.pdf", pausa_debug=True)